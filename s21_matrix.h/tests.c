...
// // Тесты для функции -- int s21_calc_complements(matrix_t *A, matrix_t
// *result);
...
// // Тесты для функции -- int s21_inverse_matrix(matrix_t *A, matrix_t
// *result);
START_TEST(s21_inverse_matrix_test_1) {
  ...
  int return_code = s21_inverse_matrix(&A, &result);
...
// Набор тестов для функции -- int s21_mult_number(matrix_t *A, double
// number,
// matrix_t *result);
...
// Набор тестов для функции -- int s21_transpose(matrix_t *A, matrix_t
// *result);
...
// Набор тестов для функции -- int s21_determinant(matrix_t *A, double
//*result);
